    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#020711] px-4">
        <div className="w-full max-w-md rounded-2xl border border-[#1a4a2a] bg-[#0a2010] p-8 text-center">
          ...
          <h2 className="mb-2 text-xl font-bold text-white">Muvaffaqiyatli yuborildi!</h2>
          ...
          {hasTelegram && redirectCountdown !== null && (
            <div className="mt-5 flex flex-col items-center gap-3">
              <div className="flex items-center gap-2 rounded-xl border border-[#1a3a4a] bg-[#091827] px-4 py-3 text-sm text-[#9ab8cc]">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" className="shrink-0 text-[#229ED9]">
  ...
  return (
    <div className="min-h-screen bg-[#020711] px-4 py-10">
      <div
        ...
        style={{ background: "radial-gradient(circle at top, rgba(106,167,255,0.1), transparent 40%)" }}
      />
      <div className="relative mx-auto w-full max-w-lg">
        <div className="mb-6 overflow-hidden rounded-[28px] border border-[#1e3448] bg-[linear-gradient(180deg,rgba(15,34,49,0.94),rgba(9,22,34,0.96))] shadow-[0_24px_80px_rgba(0,0,0,0.28)]">
          ...
          <div className="px-6 py-6 text-center">
            <p className="text-[11px] font-semibold tracking-[0.32em] text-[#7e9bb1] uppercase">Lead Form</p>
            <h1 className="mt-3 text-2xl font-bold text-white">{form.title}</h1>
            {form.description && (
              <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-[#9ab8cc]">{form.description}</p>
            )}
          </div>
        </div>
        ...
        >
          <FormFields fields={form.fields || []} fieldValues={fieldValues} setFieldValue={setFieldValue} />
...
function FormFields({ fields, fieldValues, setFieldValue }) {
